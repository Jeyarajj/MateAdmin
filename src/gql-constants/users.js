...
export const UPDATEUSER = gql`
        mutation UserProfileUpdate($token: ID, $userid:String,$updates: UserProfileUpdates!) {
...
export const CREATEROLE = gql`
    mutation rolecreation($role_id:ObjectID,$role_name:String!,$created_by:ObjectID,$rolepermission:[Permission]){
        roleCreation(role_id: $role_id,role_name:$role_name,created_by:$created_by,rolepermission:$rolepermission){
            _id
            role_name       
        }
    }
