    ...
    <b-card>
      <b-card-header>
        ...
        <div class="card-header-actions">
          ...
          aria-pressed="true"
          size="sm"
          @click="scholarshipModal = true"
        >
          <i class="icon-plus"></i> Add New Scholarship
        </b-button>
        </div>
      </b-card-header>
      ...
      <b-card-body>
        <v-client-table
          ...
          id="dataTable1"
        >
        <a slot="actions" slot-scope="props" @click="scholarshipModal = true" :href="props.row.actions" class="icon-eye"></a>
...
export default {
  ...
  data: function() {
    return {
      headers: ["name", "website","description", "status", "actions"],
      roleLimit: 10,
