    ...
    <b-card>
      ...
      <b-card-body>
        <v-client-table
          ...
          id="dataTable1"
        >
        <a slot="actions" slot-scope="props" @click="courseModal = true" :href="props.row.actions" class="icon-eye"></a>
...
export default {
  ...
  data: function() {
    return {
      headers: ["coursename", "courselevel","degree", "status", "actions"],
      roleLimit: 10,
      ...
      options: {
        ...
        sortable: ["courselevel"],
        filterable: ["courselevel"],
        sortIcon: {
          base: "fa",
          up: "fa-sort-asc",
          down: "fa-sort-desc",
