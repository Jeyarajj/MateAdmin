    ...
    <b-card>
      <b-card-header>
        ...
        <div class="card-header-actions">
          ...
          aria-pressed="true"
          size="sm"
          @click="institutionModal = true"
        >
          <i class="icon-plus"></i> Add New Institution
        </b-button>
        </div>
      </b-card-header>
      ...
      <b-card-body>
        <v-client-table
          ...
          id="dataTable1"
        >
        <a slot="actions" slot-scope="props" @click="institutionModal = true" :href="props.row.actions" class="icon-eye"></a>
...
export default {
  ...
  data: function() {
    return {
      headers: ["name", "mail","city", "address", "status"],
      roleLimit: 10,
